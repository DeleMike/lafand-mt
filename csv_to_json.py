...
def combine_texts_lafand(input_path, output_path, direction='en-sw', n_sent=600000):
    ...
    df_train = pd.read_csv(input_path + 'yad_test_with_no_accents_only.tsv', sep='\t') #[For CSV, use sep=',']
    ...
    export_json_files(output_dir, 'yad_test_with_no_accents_only.json', df_train_sctg, direction=direction)
